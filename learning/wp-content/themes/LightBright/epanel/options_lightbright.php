...
$options = array (
	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Number of Posts displayed on Post Types categories pages",
                   "id" => $shortname."_archive_customposts",
                   "std" => "5",
                   "type" => "text",
				   "desc" => "Here you can choose the number of posts to display on Post Types Categories. "),
			
			array( "name" => "Number of Posts displayed on Taxonomy & Archive pages",
		...
		array( "name" => "Cufon Text Replacement",
			   "id" => $shortname."_cufon",
			   "type" => "checkbox2",
			   "std" => "on",
			   "desc" => "Here you can choose to use Cufon Font Replacement. "),
		...
		array( "name" => "general-2",
			...
			array( "name" => "Number of Posts displayed on Homepage",
                   "id" => $shortname."_homepage_posts",
                   "std" => "8",
                   "type" => "text",
				   "desc" => "Here you can choose the number of posts you would like to display on the homepage. "),
...
function custom_colors_css(){
	...
	<style type="text/css">
		#container { color: #<?php echo(get_option($shortname.'_color_mainfont')); ?>; }
		a { color: #<?php echo(get_option($shortname.'_color_mainlink')); ?>; }
		ul.nav li a { color: #<?php echo(get_option($shortname.'_color_pagelink')); ?>; }
		ul.nav li a:hover { color: #<?php echo(get_option($shortname.'_color_pagelink_active')); ?>; }
		...
		#footer a, #footer a:visited { color:#<?php echo(get_option($shortname.'_color_footerlinks')); ?> }
	</style>
