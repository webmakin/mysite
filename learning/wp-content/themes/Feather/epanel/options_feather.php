	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => esc_html__("Show Twitter Icon",$themename),
                   ...
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => esc_html__("Here you can choose to display the Twitter Icon on the homepage. ",$themename)
			),
			...
			array( "name" => esc_html__("Show RSS Icon",$themename),
                   ...
                   "type" => "checkbox2",
                   "std" => "on",
                   "desc" => esc_html__("Here you can choose to display the RSS Icon on the homepage. ",$themename)
			),
			...
			array( "name" => esc_html__("Show Facebook Icon",$themename),
                   ...
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => esc_html__("Here you can choose to display the Facebook Icon on the homepage. ",$themename)
			),
			...
			array( "name" => esc_html__("Twitter Profile Url",$themename),
                   ...
                   "std" => "#",
                   "type" => "text",
				   "desc" => esc_html__("Place your Twitter Profile URL here. ",$themename)
			),
			...
			array( "name" => esc_html__("RSS Icon Url",$themename),
                   ...
                   "std" => "",
                   "type" => "text",
				   "desc" => esc_html__("Place your RSS URL here. ",$themename)
			),
			...
			array( "name" => esc_html__("Facebook Profile Url",$themename),
                   ...
                   "std" => "#",
                   "type" => "text",
				   "desc" => esc_html__("Place your Facebook Profile URL here. ",$themename)
			),
		...
		array( "name" => "general-2",
			...
			array( "name" => esc_html__("Display Recent Blog Posts Section",$themename),
                   "id" => $shortname."_display_recentblog_section",
                   "type" => "checkbox2",
                   "std" => "on",
                   "desc" => esc_html__("Here you can choose to display the Recent Blog Posts Section on the homepage. ",$themename)
			),
			...
			array( "name" => esc_html__("Quote Text",$themename),
			...
			array( "name" => esc_html__("Content Area 4 Page",$themename),
			...
			array( "name" => esc_html__("Recent Blog Posts Section Category",$themename),
				   "id" => $shortname."_home_recentblog_section",
				   "std" => "",
				   "type" => "select",
				   "desc" => esc_html__("Here you can choose the category you would like to display in the Recent Blog Posts Section on the homepage. ",$themename),
				   "options" => $site_cats),
				   
			array( "name" => esc_html__("Recent Blog Posts Section description",$themename),
                   "id" => $shortname."_homeblog_desc",
                   "std" => "Duis ligula massa consectetur a tincidunt pulvinar",
                   "type" => "text",
				   "desc" => esc_html__("Recent Blog Posts Section description",$themename)
			),
				   
			array( "name" => esc_html__("Recent Work Section description",$themename),
                   "id" => $shortname."_homework_desc",
                   "std" => "Sendun ligula massa consectetur a tincidunt pulvinar",
                   "type" => "text",
				   "desc" => esc_html__("Recent Work Section description",$themename)
			),
			...
			array( "name" => esc_html__("Number of Posts in Recent Work Section",$themename),
                   ...
                   "std" => "10",
                   "type" => "text",
				   "desc" => esc_html__("Here you can designate how many recent articles are displayed in Media bar on the homepage. ",$themename)
			),
			...
			array( "name" => esc_html__("Exclude categories from Recent Work Section",$themename),
				   ...
				   "type" => "checkboxes",
				   "std" => "",
				   "desc" => esc_html__("If you would like to exlcude certain category from the list you can do so here. ",$themename),
				   "usefor" => "categories",
				   "options" => $cats_ids),
				   							   
			array( "name" => esc_html__("Number of Recent Posts displayed on homepage ( in Blog style mode )",$themename),
		...
		array( "name" => "general-3",
			...
			array( "name" => esc_html__("Featured Category",$themename),
